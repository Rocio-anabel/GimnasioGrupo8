...
public class GimnasioGrupo8 {
    ...
    public static void main(String[] args) {
        ...
        Socio laura = new Socio(2,"38654221", "Laura", "Martinez", 30, "lauritamarr001@gmail.com", "2665312040", true);
        Membresia memb = new Membresia(2, laura, 4560, 12, LocalDate.of(2024, 5, 10), LocalDate.of(2024, 6, 15), true);
        Entrenador mariana = new Entrenador(2, "32678542", "Mariana", "Ochoa", "Relajación", true);
        Clase pilates = new Clase(2, "Pilates", mariana, LocalTime.of(18, 30), 3, true);
        ...
        laura = new Socio(2, "38654221", "Laura", "Martinez", 31, "lauritamarr001@gmail.com", "2665312040", true);
        sd.modificarSocio(laura);
        
        System.out.println("----------------------------------------------");
        System.out.println("Entrenador:");
        EntrenadoresData ed = new EntrenadoresData();
        Entrenador pablo = new Entrenador("39843222", "Pablo", "Mendoza", "Musculatura", true);
        //ed.guardarEntrenador(pablo);
        System.out.println(pablo.getId_Entrenador());
        
        System.out.println("----------------------------------------------");
        System.out.println("Clases:");
        ClaseData cd = new ClaseData();
        pablo = new Entrenador(4,"39843222", "Pablo", "Mendoza", "Musculatura", true);
        Clase musculacion = new Clase("Musculación", pablo, LocalTime.of(16, 30), 10, true);
        //cd.guardarClase(musculacion);
        
        System.out.println(cd.buscarClasePorNombre("pilates"));
        System.out.println(cd.buscarClasePorHorario(LocalTime.of(18, 30)));
        ...
        pilates = new Clase(2, "Pilates", mariana, LocalTime.of(18, 30), 10, true);
        ...
        memb = new Membresia(2, laura, 4560, 12, LocalDate.of(2024, 5, 10), LocalDate.of(2024, 6, 10), true);
